---
schema: default
title: Supluskohtade veeproovid
title_en: Water Quality - Tests from Bathing Spots in Estonia
...
resources:
  - name: Supluskohtade veeproovid
    ...
    interactive: 'False'
  - name: Schema
    url: 'http://vtiav.sm.ee/index.php/opendata/supluskoha_veeproovid.xsd'
    format: XSD
    interactive: 'False'
  - name: Kirjeldus
    url: 'http://vtiav.sm.ee/index.php/opendata/supluskoha_veeproovid.pdf'
    format: PDF
    interactive: 'False'

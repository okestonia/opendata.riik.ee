---
schema: default
title: Eesti Hariduse Infosüsteemi avaandmed - õppeasutused
title_en: Estonian Education Information System Datasets - Educational Institutions
...
Antud andmestikus on õppeasutuste tegevusload, mille API päringute koostamise kohta on info alapeatükis 2.1. Õppeasutuste avaandmete päring võimaldab pärida õppeasutusi registrikoodi, nimetuse, EHISe ID, õppekeele, omandivormi, õppevormi, õppeasutuse liigi, omaniku, asukoha (maakonna täpsus), tegutsemise vormi järgi. Lisaks on võimalik andmete pärijal määrata, kas otsing teostatakse omaniku ja vanade nimetust järgi ning suletud õppeasutuste hulgast."
notes_en: ''
department: ''
category:
...
resources:
  - name: Õppeasutuste avaandmed - kõikide andmete API päring
    url: 'http://enda.ehis.ee/avaandmed/rest/oppeasutused/-/-/-/-/-/-/-/-/-/-/0/0/XML'
    format: XML
    interactive: 'False'
